...
(window.LESSONS = window.LESSONS || []).push(
{
  ...
  cheat: "At the top marginal rate the Division 293 comparison is 30% inside super against 47% outside, a wedge of seventeen percentage points.",
...
},
{
  ...
  cheat: "Carried-forward contributions count for Division 293, so a catch-up year is not bounded by 15% of the $32,500 standard cap.",
...
},
{
  ...
  cheat: "The $250,000 Division 293 threshold has no indexation mechanism since 2017-18; the concessional cap is AWOTE-indexed, $32,500 for 2026-27.",
