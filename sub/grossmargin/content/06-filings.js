...
(window.LESSONS = window.LESSONS || []).push(
{
  ...
  cheat: "Read Item 1 once per company, then only Items 1A, 7 and 8 each year, in that order.",
...
},
{
  ...
  cheat: "Ask finance whether any headcount reclassification into cost of revenue is planned before you commit to a margin target.",
