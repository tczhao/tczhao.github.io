...
},
{
  ...
  cheat: "Rewrite each prompt-level rule as a predicate over resolved tool arguments; the ones that will not convert are unenforced.",
...
},
{
  ...
  cheat: "Default-deny outbound from the tool sandbox, then count your wildcards; one over a CDN or storage host is an open channel.",
