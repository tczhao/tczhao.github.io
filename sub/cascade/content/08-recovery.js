...
},
{
  ...
  cheat: "Before any full restart, multiply backend query rate by one over the miss rate and compare with the backend's measured saturation point.",
...
},
{
  ...
  cheat: "Reverting a worker image wedges in-flight Temporal executions the new code touched, so the runbook step is patch or version gate, not revert.",
